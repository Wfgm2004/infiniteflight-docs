...
Upon reaching the session limit, Trainers must contact an IFATC Moderator to review overall Trainee's progress to determine preparedness for testing, need for termination, or will allocate more sessions to reach skill level required for certification.
...
- [ ] Weather / ATIS
- [ ] Pushback / Taxi Commands/Drag to push/taxi
